...
export default function FeatureCard({
  ...
  return (
    <article
      className={
        isCompact
          ? "rounded-xl border border-white/20 bg-white/15 p-4 hover:bg-white/20 hover:border-white/30 hover:scale-[1.02] transition-all duration-300 group text-center"
